          ...
          <div className="header__cart-wrapper h-full col-span-4 flex justify-end items-center">
            ...
            <div className="cart__wrapper mr-[22px]">
              <a href="/cart" className="cart__link flex">
                <div className='mr-2'>
                  <FontAwesomeIcon className='text-base text-[#333]' icon={faCartShopping} />
                </div>
            ...
            <div className="func__wrapper">
              <a href="/" className="func__link">
                <span className="text-[16px] text-[#333] text-center">24h Công nghệ</span>
              </a>
            </div>
            <div className="func__wrapper">
              <a href="/" className="func__link">
                <span className="text-[16px] text-[#333] text-center">Hỏi đáp</span>
              </a>
            </div>
          </div>
        </div>
          ...
          <ul className="header__sub-list flex items-center justify-between">
            <li className="header__sub-item">
              <a href="/dtdd" className="header__sub-link flex">
                ...
                <span className="text-[15px] leading-[20px] text-black">Điện thoại</span>
              </a>
            </li>
            <li className="header__sub-item">
              <a href="/laptop" className="header__sub-link flex">
                <i className="mr-1">
                  <img src={icons.laptop} alt="" className="w-[20px] h-[20px]" />
                </i>
                <span className="text-[15px] leading-[20px] text-black">Laptop</span>
              </a>
            </li>
            <li className="header__sub-item">
              <a href="/tablet" className="header__sub-link flex">
                <i className="mr-1">
                  <img src={icons.tablet} alt="" className="w-[20px] h-[20px]" />
                </i>
                <span className="text-[15px] leading-[20px] text-black">Tablet</span>
              </a>
            </li>
            <li className="header__sub-item">
              <a href="/phu-kien" className="header__sub-link flex">
                <i className="mr-1">
                  <img src={icons.phu_kien} alt="" className="w-[20px] h-[20px]" />
                </i>
                <span className="text-[15px] leading-[20px] text-black">Phụ kiện</span>
                <FontAwesomeIcon className="h-[20px] ml-1 text-xs" icon={faCaretDown} />
              </a>
            </li>
            <li className="header__sub-item">
              <a href="/smart-watch" className="header__sub-link flex">
                <i className="mr-1">
                  <img src={icons.smart_watch} alt="" className="w-[20px] h-[20px]" />
                </i>
                <span className="text-[15px] leading-[20px] text-black">Smart watch</span>
              </a>
            </li>
            <li className="header__sub-item">
              <a href="/dong-ho" className="header__sub-link flex">
                <i className="mr-1">
                  <img src={icons.dong_ho} alt="" className="w-[20px] h-[20px]" />
                </i>
                <span className="text-[15px] leading-[20px] text-black">Đồng hồ</span>
              </a>
            </li>
            <li className="header__sub-item">
              <a href="/px" className="header__sub-link flex">
                <i className="mr-1">
                  <img src={icons.pc} alt="" className="w-[20px] h-[20px]" />
                </i>
                <span className="text-[15px] leading-[20px] text-black">Pc, máy in</span>
                <FontAwesomeIcon className="h-[20px] ml-1 text-xs" icon={faCaretDown} />
              </a>
            </li>
            <li className="header__sub-item">
            ...
            <li className="header__sub-item">
              <a href="/card" className="header__sub-link flex">
                <span>Sim, thẻ cào</span>
              </a>
            </li>
            <li className="header__sub-item">
              <a href="/dich-vu" className="header__sub-link flex">
